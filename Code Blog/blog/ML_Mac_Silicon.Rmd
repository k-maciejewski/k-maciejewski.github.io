...
I was so excited to update from my MacBook Air to the new Pro, especially since I boosted the memory and RAM!

However, I had a new project, for which I planned to use Rstudio, Tensorflow and Keras, and was initially met with frustration when trying to use these with my new computer. Most posts I found reference OS 11, but my computer was preloaded with OS 12. After many days, I finally found success. Hopefully, this helps someone else, too.
